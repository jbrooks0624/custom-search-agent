...
class SearchInput(BaseModel):
    ...
    metadata: dict[str, Any] = Field(
        ...
        description="Custom metadata for tracking/logging"
    )
...
class SearchResult(BaseModel):
    ...
    raw_content: str | None = Field(
        default=None,
        description="Full parsed content (if include_raw_content was enabled)"
    )
    published_date: str | None = Field(
        default=None,
        description="Publication date (only for news topic)"
    )
...
class SearchOutput(BaseModel):
    ...
    answer: str | None = Field(
        default=None,
        description="LLM-generated answer (if include_answer was enabled)"
    )
    images: list[ImageResult] = Field(
        default_factory=list,
        description="Related images (if include_images was enabled)"
    )
    ...
    raw_response: dict[str, Any] | None = Field(
        default=None,
        description="Raw API response (optional, for debugging)"
    )
